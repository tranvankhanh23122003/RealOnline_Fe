...
import { FaCheckCircle, FaRegStickyNote } from 'react-icons/fa';
import { MdWarning } from "react-icons/md";
import { GiNotebook } from 'react-icons/gi';
import Slide1 from "../../../assets/images/baner1.png";
import CancelBookingForm from '../HuyDatCho';
import "./style.css";
...
const InfoOrderDetails: React.FC<InfoOrderDetailsProps> = ({ selectedItem, onBack }) => {
  ...
  return (
    <div className="info-order-container">
      {showCancelForm ? (
        <CancelBookingForm code={item.code} onClose={handleCloseCancelForm} />
      ) : (
        <>
          <h1 
            className="info-order-title text-3xl font-bold text-gray-800 mb-4 cursor-pointer hover:text-blue-600"
            onClick={onBack}
          >
            &lt; Chi tiết căn
          </h1>
          ...
          <div className="info-order-timeline-section">
            <div className="flex w-full p-6 gap-10">
              ...
              <div className="w-1/3 text-sm">
                ...
                <p className="font-semibold">BẾ THỊ HẰNG</p>
                <p>285501035</p>
                <p>0966233290</p>
                <p>bethihangsmr@gmail.com</p>
                <p>
